...
public class DonHangService {
    ...
    public boolean hasUserPurchasedProduct(NguoiDung user, Integer productId) {
        ...
        // Replaced O(N) query logic fetching all user orders + N detail queries
        // with a single O(1) database query check for massive speedup.
        return chiTietRepository.existsByNguoiDungAndSanPhamAndTrangThaiHoanThanh(user, productId);
    }
